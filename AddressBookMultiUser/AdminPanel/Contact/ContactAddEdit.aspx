...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <asp:TextBox ID="txtBirthDate" TextMode="Date" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            <asp:CheckBoxList runat="server" ID="cblContactCategory" RepeatDirection="Horizontal" CellPadding="5" >
            </asp:CheckBoxList>
        </div>
    </div>
    <div class="form-group row">
